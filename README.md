...
- [ML Canvas](docs/ml_canvas.md) — problema de negócio, stakeholders, restrições, métricas e SLOs
- [Planejamento inicial](docs/internal/planejamento_inicial.md)
- [Tech Challenge](docs/internal/tech_challenge.md)
